...
class RootController(BaseController):
    ...
    global accCost
    global Plant_Price#åä½ç¨
    global beginTime#2011å¹´1æ1æ¥0æ¶0åå¸¸é
    global houses#æ°å±çäº§åè¡¨
    global soldie#å£«åµåè¡¨
    global soldiernum#å£«åµç»éª
    global production#åä¸åè¡¨
    global read#readåé¨å½æ°
    global mapKind#å°å¾ç§ç±»å¯¹åºæå¤§ç¨æ·æ°åè¡¨
    global makeMap#åé¨å½æ°ï¼æ°å»ºå°å¾
    global insert#åé¨å½æ°ï¼å¢å warmapä¸­numæ°
    global getMap#åé¨å½æ°ï¼è·åç±»åä¸ºkindçæç©ºä½çå°å¾
    global upd#åé¨å½æ°ï¼ä»æ§å°å¾åçº§å°æ°å°å¾
    global housebuild#æ°å±å»ºç­åè¡¨
    global resourcebuild#èµæºå»ºç­ç©åè¡¨
    global milbuild#åäºå»ºç­ç©åè¡¨
    global businessbuild#åä¸å»ºç­ç©åè¡¨
    global godbuild#ç¥åå»ºç­ç©åè¡¨
    global statuebuilding#éåå
    global decorationbuild#è£é¥°åè¡¨
    global specialgoods#åé¨å½æ°ï¼å¤æ­å»ºç­ç©ç¹æ®ç©åæ¯å¦å¾å°æ»¡è¶³
    global getGround_id#åé¨å½æ°,è¿åå»ºç­ç©idå¯¹åºåè¡¨
    global stones#ç³å¤´ç§ç±»åè¡¨
    global woods#æ¨å¤´ç§ç±»åè¡¨
    global expanding#æ©å°åè¡¨
    global EXPANDLEV#æ©å°æé«ç­çº§
    global getbonus#åé¨å½æ°ï¼ææªå¥å±
    global loginBonus#åé¨å½æ°ï¼ç»å½å¥å±
    global alphabet#ç¹æ®ç©åå¯¹åºå­æ¯åè¡¨a-l
    global randombuilding#æ²¡æè¢«ä½¿ç¨ï¼éæºä¸çº§å»ºç­ç©åè¡¨
    global present#æ²¡æè¢«ä½¿ç¨ï¼åé¨å½æ°
    global inornot#åé¨å½æ°ï¼å¤æ­æ´æ°æ¯å¦å¨åè¡¨å
    global allyup#æ¯ä¸ªçµä½ç­çº§é»è®¤åå§æ¥ææå¤çåæ°
    global NOBILITYUP#çµä½æé«ç­çº§0-6
    global INITIALSTR#æ²¡æè¢«ä½¿ç¨ï¼åå§åå­ç¬¦ä¸²
    global INITIALSTR2#æ­£å¨ä½¿ç¨ï¼åå§åå­ç¬¦ä¸²
    global loginbonuslist#ç»å½å¥å±åè¡¨ï¼è¿ç»­ç»å½å¥å±
    global timejudge #åé¨å½æ°ï¼å¤æ­æ¶é´æ¯å¦ç¸å·®ä¸å¤©function pan duan shifou duguo 0 dian 
    global giftstring #åé¨å½æ°ï¼è¿åç¨æ·ç¸å³ç¤¼ç©å­ç¬¦ä¸² function giftstring
    global sg#åé¨å½æ°ï¼èµ éç¹æ®ç©åä½ä¸ºç¤¼ç©
    global minusstateeli#åé¨å½æ°ï¼æ¶é¤è´é¢ç¶æfunction eliminating minusstate
    global completereceive#åé¨å½æ°ï¼å®æç¤¼ç©èµ äºææ¶å
    global checkminusstate#åé¨å½æ°ï¼æ¥è¯¢è´é¢ç¶ææ¯å¦å­å¨
    global monsterlist#æªç©åè¡¨
    global returnSoldier#åé¨å½æ°ï¼è¿åå£«åµæ°é
    global returnsentouryoku#åé¨å½æ°ï¼è¿åååææå
    global checkopdata#function,cache
    global deleteopdata#function,cache
    global returnscout#åé¨å½æ°ï¼è¿åä¾¦å¯åµæ°éfunction,return scout num of user
    global defencepowerlist#æ¯ä¸çº§åå ¡é²å¾¡ålist of defence power of each nobility
    global allyhelp#åé¨å½æ°è¿åçåæä¾æåfunction ally help
    global getbonusbattle#åé¨å½æ°ï¼è¿åææå¥å±functionspecialgoods bonus for battle
    global warresult#åé¨å½æ°ï¼è¿åæäºç»æfunction  calculate result of battles
    global functionname#å½æ°ååè¡¨list of function name
    global calev#åé¨å½æ°ï¼è®¡ç®çµä½ç­çº§function castle lev up
    global addnews#åé¨å½æ°ï¼æ°é»function add news
    global opentreasurebox#åé¨å½æ°ï¼è®¡ç®æå¼å®ç®±å¥å±function
    global nobilitybonuslist#çµä½åçº§å¥å±
    global tasklist#ä»»å¡åè¡¨
    #global newtask#åé¨å½æ°ï¼æ°ä»»å¡
    global mktaskstr#åé¨å½æ°ï¼è®¡ç®ä»»å¡å­ç¬¦ä¸²
    global checkfriend#åé¨å½æ°ï¼æ£æ¥æ¯å¦å¨å¥½ååè¡¨ä¸­
    global md5string#è®¡ç®md5ç¨string
    global judgemd5#åé¨å½æ°ï¼è®¡ç®md5
    global CACHEOP#å¸¸éï¼cacheè°ç¨æ¬¡æ°ã
    global addcache#åé¨å½æ°ï¼åcacheä¸­åå¥æ°æ®
    global replacecache#åé¨å½æ°
    global cachewriteback#åé¨å½æ°
    global callost#åé¨å½æ°ï¼è®¡ç®æå¤±
    global getresource
    global warresult2
    global calGod
    ...
    #milbuildï¼corn,food,labor_num,resource,update(cae),exp,timeï¼ç¹æ®ç©åï¼è§£éç­çº§
    ...
    #businessbuildï¼corn,food,labor,resource,update(cae),exp,timeï¼ç¹æ®ç©åï¼è§£éç­çº§
    ...
    #godbuild corn,food,åçº§cae,exp,äººå£ä¸épopulationupboundï¼æ¶é´
    ...
    #decorationbuildï¼cornorcaeï¼äººå£ä¸éï¼è§£éç­çº§
    ...
    #åä½ç©listï¼#corn,exp,food,timeï¼è§£éç­çº§
    ...
    #äººå£æå æåäººå£æ°population,æ¶èfood,exp got,caeï¼ä¸ç¨ï¼ 
    houses=[[10,20,1,1800,1],[15,30,2,1800,1],[20,40,5,1800,1],[10,20,1,1800,1],[15,30,2,1800,1],[20,40,5,1800,1],[10,20,1,1800,1],[15,30,2,1800,1],[20,40,5,1800,1],[10,20,1,1800,1],[15,30,2,1800,1],[20,40,5,1800,1],[32,64,3,7560,1],[43,86,7,7560,1],[55,110,11,7560,1],[32,64,3,7560,1],[43,86,7,7560,1],[55,110,11,7560,1],[32,64,3,7560,1],[43,86,7,7560,1],[55,110,11,7560,1],[32,64,3,7560,1],[43,86,7,7560,1],[55,110,11,7560,1],[70,140,7,18720,2],[83,174,14,18720,2],[100,200,21,18720,2],[70,140,7,18720,2],[83,174,14,18720,2],[100,200,21,18720,2],[70,140,7,18720,2],[83,174,14,18720,2],[100,200,21,18720,2],[70,140,7,18720,2],[83,174,14,18720,2],[100,200,21,18720,2],[50,90,6,12600,2],[62,116,10,12600,3],[75,142,17,12600,3],[50,90,6,12600,2],[62,116,10,12600,3],[75,142,17,12600,3],[50,90,6,12600,2],[62,116,10,12600,3],[75,142,17,12600,3],[50,90,6,12600,2],[62,116,10,12600,3],[75,142,17,12600,3],[95,190,12,29880,3],[115,230,24,29800,3],[135,270,36,29800,3],[95,190,12,29880,3],[115,230,24,29800,3],[135,270,36,29800,3],[95,190,12,29880,3],[115,230,24,29800,3],[135,270,36,29800,3],[95,190,12,29880,3],[115,230,24,29800,3],[135,270,36,29800,3],[100,150,15,14400,4],[150,225,25,14400,4],[200,300,35,14400,4],[100,150,15,14400,4],[150,225,25,14400,4],[200,300,35,14400,4],[100,150,15,14400,4],[150,225,25,14400,4],[200,300,35,14400,4],[100,150,15,14400,4],[150,225,25,14400,4],[200,300,35,14400,4],[110,170,17,21600,0],[165,245,26,21600,0],[230,339,39,21600,0],[110,170,17,21600,0],[165,245,26,21600,0],[230,339,39,21600,0]]##äººå£æå æåäººå£æ°population,æ¶èfood,exp got,caeï¼ä¸ç¨ï¼ 
    #å£«åµï¼corn,food,labor_num,caeï¼ä¸è¦ï¼ï¼æ¶é´
    ...
    #åä¸çäº§ äº§éï¼ç»éªï¼caeï¼ä¸è¦ï¼ï¼æ¶é´
    ...
    EXPANDLEV=10#æé«ç­çº§ ï¼ä»0å¼å§
    ...
    #woods product cost(corn or cae),exp,gain,timeï¼è§£éç­çº§
    ...
    #stones product cost(corn or cae),exp,gain,timeï¼è§£éç­çº§
    ...
    #æªå½list ææåï¼ç»éªï¼cornï¼éæºç©åæ°éï¼æå¤±ææå
    ...
    CACHEOP=10#è°ç¨10æ¬¡checkopdata
    ...
    def refreshfriend(self,uid,page):
        ...
        friendlist=[]     
        try:
            userset=DBSession.query(operationalData).filter_by(user_kind=1).order_by(operationalData.userid)#æ¯å¦åªè½è¦æ±iphoneçå¥½åï¼
            for nn in userset:
    ...
    ###########ä»»å¡ç¸å³
    @expose('json')
    def newtasktest(self,uid):#æµè¯ç¨ï¼åå»ºæ°ä»»å¡
        u=None
        tl=None
        try:
            ...
            return dict(id=tl)
    @expose('json')
    def wartaskgivenup(self,uid):#æ¾å¼ä»»å¡
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
        #tasklist=newtask(u) 
    ...
    @expose('json')
    def taskgivenup(self,uid):#æ¾å¼ä»»å¡
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
        #tasklist=newtask(u) 
        ...
        return dict(task=task[0])
    @expose('json')
    def wartaskaccomplished(self,uid):#ä»»å¡å®æ
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
    ...
    @expose('json')
    def taskaccomplished(self,uid):#ä»»å¡å®æ
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
        ...
        return dict(task=task,tid=t2) 
    @expose('json')
    def wartaskstep(self,uid,taskstring):#ä»»å¡ä¸­é´æ­¥éª¤å®æä¿å­
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
        ...
        return dict(id=1)        
    @expose('json')
    def taskstep(self,uid,taskstring):#ä»»å¡ä¸­é´æ­¥éª¤å®æä¿å­
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
    ...
    def newtask(self,uid,taskid):
        ...
        return dict(id=1)  
    def mktaskstr(lev,num):#åé¨å½æ°ï¼ä»»å¡å­ç¬¦ä¸²
    ...
    def returnfile(self,name):#å®¢æ·ç«¯ä¸è½½è¯·æ±å½æ°ï¼å¾çåç§°ä¸è½å«æâ.'å­ç¬¦ï¼è¿åå¾çåç§°ä¸ºè¾å¥åæ°nameå¼
        try:
            ...
            openfile=open('a','r')#å¦ææ²¡ææ¥å°å¾çï¼è¿åå¾ç'a'
            rd=openfile.read()
            openfile.close()
            theFile = StringIO.StringIO(rd)       
            response.headers['Content-Type']  = 'image/png'
    ...
    def checkopdata2(uid):
        ...
        #    deleteopdata(uid)#å é¤cacheä¸­å¯¹åºå¯¹è±¡
        #    u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        #    uli=[u,0]
        #    mc.add(str(uid),uli)
        #    return uli[0]            
        ...
        return ul[0]
    def replacecache(uid,u):#å°æ°å¼åå¥cacheï¼ä¸checkopdataæå¯¹ä½¿ç¨
        return 1
        #ul=mc.get(str(uid))
        #if ul!=None:
        #    ul[0]=u
    ...
    @expose('json')#æåå½æ°ï¼å¨ç¨æ·è¾¾å°5çº§æ¶è°ç¨ï¼è¥ç¨æ·æ²¡æè¯åï¼åå¨ç¨æ·10çº§æ¶åæ¬¡è°ç¨ï¼å¥å±5cae
    def rate(self,uid):
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
        u.rate=1
        ...
        return dict(id=1)
    @expose('json')
    def levup(self,uid,lev):#operationalData:update,modify ç¨æ·åçº§æ¶è°ç¨ï¼uidä¸ºç¨æ·useridï¼levä¸ºç®æ ç­çº§ï¼10ï¼30,60,100çº§æ¶å¢å äººå£ä¸é
        u=checkopdata(uid)#cache
        u.corn=u.corn+(int(lev))*200#å¥å±corn ç¨æ·ç­çº§*20 
        u.lev=int(lev)
        tasklist=[]
        task=[-1,-1]
        if u.lev%10==0:
        ...
        for xxs in xs:
            xxs.lev=u.lev
        if u.lev==10 and u.rate==0:#å½ç¨æ·å°è¾¾10çº§ä¸æ²¡æè¯åï¼åè¿årate=0åç¥å®¢æ·ç«¯ã
            return dict(task=task1,tasklist=tasklist,rate=0,id=1)
        return dict(task=task1,id=1,tasklist=tasklist)        
    def timejudge(t):#å¤æ­å½åæ¶é´åä¼ å¥æ¶é´tç¸éæ¶é´æ¯å¦è¶è¿1å¤©ãå¨selectgiftå½æ°ä¸­è¢«è°ç¨
        t2=int(time.mktime(time.localtime())-time.mktime(beginTime))
        s=t2/86400-t/86400
        if s<1 :#å¦ææ²¡æè¶è¿ä¸å¤©ï¼è¿åfalse
            return False
        else:
            return True
    def loginBonus(u):#called when login;u is the user;operationalData:query->update ç¨æ·uçæ¯æ¥ç»å½å¥å±
            ...
            if u.newcomer<3:#å½å¤å¨æ°æä»»å¡æ¶ï¼ä¸ç»ç»å½å¥å±
                return 0
            if s>1:#éæ°è®¡ç®ç»å½å¥å±
                u.loginnum=0
                u.logincard=0
            if ds.datesurprise==0 :
                
                bonus=loginbonuslist[u.loginnum]#æ ¹æ®è¿ç»­ç»å½æ¬¡æ°å³å®ç»å½å¥å±
                if bonus>0 :
                    u.corn=u.corn+bonus
                else:
                    u.cae=u.cae-bonus
                ...
                return 0 
    def inornot(num,li):#è¾å©å½æ°ï¼å¤æ­æ´æ°numæ¯å¦å¨æ´æ°åè¡¨liä¸­ in or not
        if len(li)==0:
            return False
        for i in li:
            if num==i :
                return True
        return False
    def present(u):#æ²¡æè¢«ä½¿ç¨ï¼è¿å4ä¸­éæºå»ºç­
    ...
    def getbonus(u):#è®¡ç®æè´¥æªå½åçå¥å±ï¼è¿åç¹æ®ç©åå­ç¬¦ä¸²ï¼å¨å¯¹å¤æ¥å£defeatmonsterä¸­è¢«è°ç¨
        num1=[]
        restr=''
        num2=[]
        j=0
        ...
        u.specialgoods=s        
        return s
    def getbonusbattle(u,k):#ææèå©åçå¥å±ï¼å¨warresultä¸­è¢«è°ç¨ type=1,got type=0,lost
        num1=[]
        restr=''
        num2=[]
        j=0
        ...
        return s      
    #def getbonusbattle2(u,k,type):#type=1,got,type=0,lost,k=0è¿æ»èå©ï¼1ï¼è¿æ»å¤±è´¥ï¼2é²å¾¡èå©ï¼3é²å¾¡å¤±è´¥
              
    def getbonusbattle3(u,k,type):#ææèå©åçå¥å±ï¼å¨warresultä¸­è¢«è°ç¨ type=1,got type=0,lost
        num1=[]
        restr=''
        num2=[]
        j=0
    ...
    def returnSoldier(u):#ä¸åä½¿ç¨ï¼è¿åç¨æ·uåç§å£«åµåè¡¨
        soldier=[]
        ...
        return soldier
    def returnsentouryoku(u):#è¿åç¨æ·uæ»ææå
        sentouryoku=[]
        power=u.infantrypower+u.cavalrypower
        return power     
    ##################æªå½ç¸å³    
    @expose('json')
    def monsterrefresh(self,userid,monsterstr):#å¯¹å¤æ¥å£ï¼å®¢æ·ç«¯å·æ°æªå½å­ç¬¦ä¸²ï¼monsterstr
    ...
    def foodlost(self,uid):
        ...
        return dict(foodlost = 0)
    @expose('json')
    def defeatmonster(self,uid,gridid):#å¯¹å¤æ¥å£ï¼ä¸æªå½è¿è¡ææ
        listsoldier=[]
        l2=[]
        mlist=[]
        mmlist=[]
    ...
    ##################
    ##################è´é¢ç¶æç¸å³
    def checkminusstate(gridid,mstr):#strä¸ºè¡¨ç¤ºè´é¢ç¶æçå­ç¬¦ä¸²ï¼å½æ°ç¨äºæ£æ¥æ­¤åå¸çè´é¢ç¶æä¸­æ¯å¦å«æstrç¶æï¼å¨å¯¹å¤æ¥å£addminusstateä¸­ä½¿ç¨
        ...
        for m in mlist:
            if u.minusstate.find(m)!=-1:
                if i==0:
                    ...
                    s=s+';'+m
        return s   
    def checkminusstate2(u,str):#strä¸ºè¡¨ç¤ºè´é¢ç¶æçå­ç¬¦ä¸²ï¼å½æ°ç¨äºæ£æ¥æ­¤åå¸çè´é¢ç¶æä¸­æ¯å¦å«æstrç¶æï¼å¨å¯¹å¤æ¥å£addminusstateä¸­ä½¿ç¨
        if u.minusstate.find(str)!=-1:
            return True
        else:
            return False
    @expose('json')
    def addminusstate(self,city_id,minusstr):#å¯¹å¤æ¥å£ï¼å¨åå¸city_idçgrid_idå¤ï¼å¢å ç±»åä¸ºtypeçå¼å¸¸ç¶æï¼å¼å¸¸ç¶æå­ç¬¦ä¸²å¨warmapæ°æ®åºä¸­
        #t=int(time.mktime(time.localtime())-time.mktime(beginTime))
        war=DBSession.query(warMap).filter_by(city_id=int(city_id)).one()
        str2=minusstr
        strminus=minusstr#å¼å¸¸ç¶æå­ç¬¦ä¸²ï¼æåå ', 'æ¯ä¸ºäºä½¿ç¨checkminusstateçæ¹ä¾¿
        ...
        if war.minusstate=='':
            ...
            if strminus!='':
                ...
                return dict(id=0)
    @expose('json')
    def addminusstate2(self,city_id,type,grid_id):#å¯¹å¤æ¥å£ï¼å¨åå¸city_idçgrid_idå¤ï¼å¢å ç±»åä¸ºtypeçå¼å¸¸ç¶æï¼å¼å¸¸ç¶æå­ç¬¦ä¸²å¨warmapæ°æ®åºä¸­
        #t=int(time.mktime(time.localtime())-time.mktime(beginTime))
        war=DBSession.query(warMap).filter_by(city_id=int(city_id)).one()
        str2=type+','+grid_id+', '
        strminus=type+','+grid_id#å¼å¸¸ç¶æå­ç¬¦ä¸²ï¼æåå ', 'æ¯ä¸ºäºä½¿ç¨checkminusstateçæ¹ä¾¿  
        mlist=[]  
        if war.minusstate=='':
            ...
            return dict(id=1)            
    @expose('json')
    def eliminusstate(self,uid,city_id,grid_id):#å¯¹å¤æ¥å£ï¼ç¨æ·uidå¯¹åå¸city_id grid_idå¤çè´é¢ç¶æè¿è¡æ¶é¤æä½
        stri=''
        i=0
        t=int(time.mktime(time.localtime())-time.mktime(beginTime))
        minuslist=[]
        try:
            ...
            if strminus=='' or strminus==None or minuslist==None or len(minuslist)==0:
                ...
                u.exp=u.exp+1+lev*1
                #u.corn=u.corn+50
                if u.userid!=war.userid:#å½ä¸æ¯æçèªå·±çåå ¡æ¶ï¼è®°å½æ°é»
                    try:
            ...
            return dict(id=0)         
    def minusstateeli(user,war,stri,t1):#èªå¨æ¶é¤è´é¢ç¶æï¼è¿åå¼markï¼å½mark=1æ¶ï¼åªç»ç»éªãå¨harvestï¼finipopï¼productionæ¥å£ä¸­ä½¿ç¨
        mark=0
    ...
    ################ç»çç¸å³                       
    @expose('json')
    def makeally(self,uid,fid):#å¯¹å¤æ¥å£ï¼ç¨æ·uidåfidç»ç
        uid=int(uid)
        fid=int(fid)
        #u=DBSession.query(operationalData).filter_by(userid=uid).one()
    ...
    @expose('json')
    def cancelally(self,uid,fid):#å¯¹å¤æ¥å£ï¼ç¨æ·uidåæ¶ä¸fidç¨æ·çç»çå³ç³»
        uid=int(uid)
        fid=int(fid)
        u=checkopdata(uid)#cache
        try:
            ...
            return dict(id=0)                                  
    @expose('json')
    def addallyupbound(self,userid):#å¢å å¯ç»çæ°ä¸é
        try:
            userid=int(userid)
    ...
    ################å®ç®±ç¸å³
    @expose('json')
    def newtbox(self,user_id,num):#å¯¹å¤æ¥å£ï¼ç¨æ·user_id,çææ°å®ç®±ï¼numä¸ºå®ç®±åº§ä½æ°
        try:
    ...
    def helpopen(self,user_id,fuser_id):#å¯¹å¤æ¥å£ï¼ç¨æ·user_idå¸®å© ç¨æ·fuser_id æå¼å®ç®±
        t=int(time.mktime(time.localtime())-time.mktime(beginTime))
        ...
        if u2.treasurebox!='':
            ...
            return dict(id=1)
    @expose('json')
    def selfopen(self,user_id):#ç¨æ·ä½¿ç¨caeå¸æå¼å®ç®±
        u=checkopdata(user_id)#cache
        if u.cae-1>=0:
            if u.treasurebox!='':
            ...
            return dict(id=0)
    @expose('json')
    def completeopen(self,user_id):#å¯¹å¤æ¥å£ï¼å®ææå¼å®ç®±ï¼numä¸ºç¹æ®ç©ååè¡¨
        #u=DBSession.query(operationalData).filter_by(userid=int(user_id)).one()
        try:
            u=checkopdata(user_id)#cache
            u.treasurenum=0
            ...
            return dict(id=0)
    def opentreasurebox(u):#å®ç®±ç¤¼ç© å¨å¯¹å¤æ¥å£completeopenä¸­è¢«è°ç¨ï¼è¿åä¸¤ç§ç¹æ®ç©å
        num1=[]
        restr=''
        num2=[]
        j=0
    ...
    def specialgoods(ground_id,stri,u):#å¤æ­å»ºç­ç©çç¹æ®ç©åè¦æ±æ¯å¦å¾å°æ»¡è¶³ return true if special goods enough;operationalData:query->update
        stri='111'
        stru=u.specialgoods
        num1=[]
        num2=[]
    ...
    def getGround_id(ground_id):# return lis[]
        ...
        if ground_id==0:
            ...
            return None
    ###############èµ éç¤¼ç©ç¸å³        
    def sg(otherid,user_kind,sp):#èµ éç¹æ®ç©åä½ä¸ºç¤¼ç©
        stri='111'        
    ...
    def getgift(self,uid,off,num):#uid=papayaid
        ...
        try:
            ...
            return dict(gift=[])               
    @expose('json')
    def selectgift(self,uid,fid,specialgoods,askorgive):#å¯¹å¤æ¥å£ï¼éæ©ä¸ç§ç¹æ®ç©åä½ä¸ºç¤¼ç©ï¼0ï¼èµ éï¼1ç´¢è¦ operationalData:query;Gift:insert->update
        uid=int(uid)
        #u=DBSession.query(operationalData).filter_by(userid=uid).one()
        u=checkopdata(uid)#cache
        fid=int(fid)
        ...
        try:
            ...
            return dict(id=1)
        """
    def giftstring(uid):#ä»giftæ°æ®è¡¨ä¸­æ¥å°ç¨æ·uidç¸å³çç¤¼ç©ä¿¡æ¯logsignä¸­ä½¿ç¨...fid,present,askorgive;Gift:query
        #uid=int(uid)
        s=''
        mark=0
        try:
    ...
    @expose('json')
    def receivegift(self,uid,giftstr):#å¯¹å¤æ¥å£ï¼æ¥åç¤¼ç©giftstr
        three=[]
        uid=int(uid)
        mark=0
        #u=DBSession.query(operationalData).filter_by(userid=uid).one()
    ...
    #################è®¿é®å¥½å                  
    @expose('json')
    def getfriend(self,userid,otherid,user_kind):#å¯¹å¤æ¥å£ï¼ç¨æ·userid è®¿é®ç±otherid+user_kindç¡®å®çå¥½å get friends page;operationalData:query->updatewarMap:query;businessRead:query;visitFriend:query->update
    ...
    @expose('json')
    def sell(self,user_id,city_id,grid_id):#å¯¹å¤æ¥å£ï¼åå»ºç­ç©sell building#operationalData:update;businessWrite:query->update
        try:
            u=checkopdata(user_id)#cache
            ...
            if p.ground_id >= 420 and p.ground_id <= 429:
                ...
                DBSession.delete(p)
                return dict(id=1, result="sell friendGod or monster god suc", grid=grid_id)
    ...
    def read(city_id):# åbusinessreadè¡¨ä¸­åå¥æ°æ®
        ...
        """
    @expose('json')
    def changename(self,userid,newname):#å¯¹å¤æ¥å£ï¼æ´æ¹é¢å°å
        #u=DBSession.query(operationalData).filter_by(userid=int(userid)).one()
        u=checkopdata(userid)#cache
    ...
    @expose('json')
    def newcomplete(self,uid,level):#å¯¹å¤æ¥å£ï¼æ°æä»»å¡
        try:
            level=int(level)
    ...
    ###############
    ###############æ°é»ç¸å³
    def addnews(uid,fpapayaid,kind,time,fuser_kind):#æ·»å æ°é»å½æ°
    ...
    def getnewsnum(self,uid):#è·åæ°é»æ»æ°
        try:
            ...
            return dict(id=0)
    @expose('json')
    def getnews(self,uid,off,size):#å¯¹å¤æ¥å£ï¼è·åæ°é»
        uid=int(uid)
        newslist=[]
        nl=[]
        num=11
    ...
    @expose('json')
    #user_kind 
    def logsign(self,papayaid,user_kind,md5):# å¯¹å¤æ¥å£ï¼ç»éæ³¨ålogin if signed or sign;operationalData:query
        print "login from 1"
        user=None
        ...
        try:
            ...
            ds=DBSession.query(Datesurprise).filter_by(uid=user.userid).one()
            bonus=loginBonus(user)#è·åç»å½å¥å±
            lbonus=bonus
    ...
    NobilityName = ['三等平民','二等平民','一等平民',
                ...
                '帝王']
    global Domain
    Domain = 'http://uhz000738.chinaw3.com/'
    @expose('json')
    def upgrademap(self,userid):#å¯¹å¤æ¥å£ï¼çµä½åçº§ï¼è¿å¥æ°å°å¾ user update and go to new map#OccupationData:query operationalData:query->update;warMap:update;Victories:update
        try:
            print "upgrade map"
            userid=int(userid)
            u=checkopdata(userid)#cache
            ...
            try:
                req = Domain + 'send?uid=0&name=系统&cid='+str(myMap.mapid)+'&text=<'+u.empirename+'>升级到 '+NobilityName[(u.nobility+1)*3]+', 离开了地图'
                urllib.urlopen(req)
            except:
    ...
    @expose('json')
    def adddefence(self,uid,defencenum,type):#å¯¹å¤æ¥å£ï¼å¢å åæ± é²å¾¡å
        type=int(type)
        uid=int(uid)
        food=0
        wood=0
        ...
        try:
            ...
            return dict(id=0)
    def allyhelp(uid,type,poweru):#è®¡ç®çåææå
        uid=int(uid)
        fullpower=0
    ...
    @expose('json')
    def attack(self,uid,enemy_id,timeneed,infantry,cavalry):#å¯¹å¤æ¥å£ï¼è¿æ»
        uid=int(uid)
        enemy_id=int(enemy_id)
    ...
    def returnscout(u):#è¿åä¾¦å¯åµæ°é
        scout=[]
    ...
    @expose('json')
    def detect(self,uid,enemy_id,type):#å¯¹å¤æ¥å£ï¼ä¾¦å¯
        type=int(type)
        scout=[]
        num=[2,6,12,0]
        i=0
    ...
    def exprank(self,type,off,num,uid):
        ...
        try:
            ...
            return dict(id=0)
    @expose('json')
    def war(self,uid):#å¯¹å¤æ¥å£ï¼æäºç»æ
    ...
    def callost(myFull, eneFull, myPure, enePure, type):
        ...
        return lost     
    def getresource(kill,u,type):#type=0è¿æ»èå©ï¼1è¿æ»å¤±è´¥ï¼2é²å¾¡èå©ï¼3é²å¾¡å¤±è´¥
        bonusstring=''
    ...
    def calev(u,v):#è®¡ç®çµä½ç­çº§ï¼å¨warresultä¸­è°ç¨
        nobility1=u.nobility
        subno=0
        minus=-1
        oldSub = u.subno
    ...
    @expose('json')
    def warrecord(self,uid):#å¯¹å¤æ¥å£ï¼æç»©
        #u=DBSession.query(operationalData).filter_by(userid=int(uid)).one()
        u=checkopdata(uid)#cache
    ...
    """
    @expose('json')
    def warinfo(self,userid):#å¯¹å¤æ¥å£ï¼ææ¥
        userid=int(userid)
        v=None
        m=None
        u1=None
    ...
    GOD_TIME = [1, 6, 24]
    @expose('json')
    def godbless(self,uid,godtype,caetype):#å¯¹å¤æ¥å£ï¼æ½å ç¥è¿¹
        uid=int(uid)
        u=checkopdata(uid)#cache
        t=int(time.mktime(time.localtime())-time.mktime(beginTime))
        godtype=int(godtype)
        ...
        if godtype == 4: #friendGod or monsterGod
            if caetype >= 0 and caetype < len(caeCost):
                ...
                if len(buildings) > 0:
                   if u.cae >= caeCost[caetype]:
                        ...
                        b.object_id = caetype
                        #monster god bles
                        print "friend god or monster god bless suc "+str(godtype)
                        return dict(id=1, result = "friend god bless "+ str(caetype))
    ...
    @expose('json')
    def updatebuilding(self,user_id,city_id,ground_id,grid_id,type):# å¯¹å¤æ¥å£ï¼åçº§å»ºç­ç©update building operationalData:query->update; businessWrite:query->update
        ...
        try:
            ...
            p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
            ti=int(time.mktime(time.localtime())-time.mktime(beginTime))
            #monstergod or friendgod
            if ground_id >= 420 and ground_id <= 429:
                lev = (ground_id - 420)%5#next level
                ...
                if lev <= 4:
                    if int(type) == 0:
                        if u.cae >= friendGod[lev][5]:
                            ...
                            p.finish = 0
                            p.producttime = ti
                            if p.ground_id >=425 and ground_id <= 429:#stop monster god bless
                                statues = DBSession.query(businessWrite).filter("businessWrite.city_id=:cid and ground_id >= 600 and ground_id <= 605 and finish = 1").params(cid=int(city_id)).all()
                                for s in statues:
                                    s.producttime = 0
                                    s.object_id = -1
    ...
    #å¸®å©å¥½åï¼ ä½¿ç¨å¯æå¸æ¿æ´»å® ç© è¿å¥finishç¶æ state = 0
    @expose('json')
    ...
    def build(self,user_id,city_id,ground_id,grid_id):# å¯¹å¤æ¥å£ï¼å»ºé å»ºç­ç©build operationalData:query->update; businessWrite:query->update
        print "build " , user_id, city_id, ground_id, grid_id
        curTime=int(time.mktime(time.localtime())-time.mktime(beginTime))
        user_id = int(user_id)
        ...
        if ground_id / 1000 != 0:
            ...
            if ground_id == 1000:
                if user.lev >= demands[0] and user.food >= demands[1] and user.corn >= demands[2]:
                    ...
                    dragon = Dragon(uid = user_id, bid = building.bid, friNum = 0, state=0,  health = 0, name = 'æçå® ç©', kind = 0, friList= '[]', lastFeed = 0, attack=0, trainNum = 0)
        ...
        if ground_id >=600 and ground_id <=605:
            ...
            if user.lev >= statuebuilding[index][0] and idlepop >= statuebuilding[index][3]:
                ...
                """
                buildings = DBSession.query(businessWrite).filter("ground_id >= 425 and ground_id <= 429").all()
                if len(buildings) > 0:
                    mongod = buildings[0]
                    if mongod.object_id != -1:
                """     
    ...
    @expose('json')
    def planting(self,user_id,city_id,grid_id,object_id,type):#å¯¹å¤æ¥å£ï¼ç§æ¤ï¼èµæºè·åoperationalData:query->update; businessWrite:query->update
        try:
            if int(type)==0:
    ...
    @expose('json')
    def harvest(self,user_id,city_id,grid_id,type):#å¯¹å¤æ¥å£ï¼ç§æ¤ï¼èµæºæ¶è·warMap:query;operationalData:query->update; businessWrite:query->update
        try:
            type=int(type)
            p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
            u=checkopdata(user_id)#cache
            ...
            if u.food_god==1 and t-u.foodgodtime<3600:
                ...
                u.foodgodtime=-1                                
            tu=[]
            if p.ground_id==2:#æ°´æ¶åç°
                factor2=1.2
            elif p.ground_id==3:#å®ç³åç°
                factor2=1.4
            elif p.ground_id==4:#ç²¾çµåç°
                factor2=1.6
            if type==0:
    ...
    """
    #check if the monster god bless or not
    monster_god = DBSession.query(businessWrite).filter("city_id=:cid and ground_id >= 425 and  ground_id <= 429").params(cid=city_id).one();
    if monster_god.producttime > 0:
    p.object_id = (monster_god.object_id*3600+monster_god.producttime-ti)/3600
    if (monster_god.object_id*3600+monster_god.producttime-ti)%3600 != 0:# less than an hour = an hour
    p.object_id += 1
    p.producttime = ti
    print "product defence"
    else:
    p.producttime = 0
    p.object_id = -1
    """
    @expose('json')
    def finish_building(self,user_id,city_id,grid_id):#å¯¹å¤æ¥å£ï¼å®æå»ºç­ç©å»ºé operationalData:query->update; businessWrite:query->update
        try:
           p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
           lis=getGround_id(p.ground_id)
           u=checkopdata(user_id)#cache
    ...
    def accCost(timeLeft):
        ...
        return caesars   
    @expose('json')
    def speedup(self,user_id,city_id,grid_id):#å¯¹å¤æ¥å£ï¼å éoperationalData:query->update; businessWrite:query->update
        try:
            caesars=1
            p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
            u=checkopdata(user_id)#cache
            ...
            if p.ground_id >= 420 and p.ground_id <= 429:
                if p.finish == 0:
                    ...
                    if u.cae >= cost:
                        ...
                        p.producttime = 0
                        DBSession.flush()
                        return dict(id=1, result = "firendgod or monster god finish suc", caeCost = cost)
                return dict(id=1, result = "firendgod or monster god finish suc", caeCost = cost)
            if p.ground_id >=600 and p.ground_id <=605:
                if p.finish == 0:
                    index = p.ground_id - 600
                    ...
                    if u.cae >= cost:
                        ...
                        if monster_god.producttime > 0:
                           ...
                           if (monster_god.object_id*3600+monster_god.producttime-ti)%3600 != 0:# less than an hour = an hour
                               p.object_id += 1
                           p.producttime = ti
                           print "speed up statue with mon god"
                        """
                        DBSession.flush()
    ...
    @expose('json')
    def population(self,user_id,city_id,grid_id):#å¯¹å¤æ¥å£ï¼æåäººå£recruit population;operationalData:query->update; businessWrite:query->update
        try:
            p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
            ...
            return dict(id=0)
    @expose('json')
    def finipop(self,user_id,city_id,grid_id):#å¯¹å¤æ¥å£ï¼å®æäººå£æå finish population;warMap:query; operationalData,businessWrite:query->update
        try:
            p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
            u=checkopdata(user_id)#cache
            war=DBSession.query(warMap).filter_by(city_id=int(city_id)).one()
            ...
            return dict(id=0)
    @expose('json')
    def training(self,user_id,city_id,grid_id,sid):# å¯¹å¤æ¥å£ï¼è®­ç»å£«åµtraining soldiers; operationalData:query->update; businessWrite:query->update
        try:
           p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
           i=int(sid)
           #three=soldier[i]
           ...
           if u.corn-corn>=0 and u.food-foo>=0 and u.population-pop>=u.labor_num and p.producttime==0 and p.finish==1:
            ...
            return dict(id=0)
    @expose('json')
    def soldier(self,user_id,city_id,grid_id):#å¯¹å¤æ¥å£ï¼å®æå£«åµè®­ç» finish training warMap:query;businessWrite,operationalData:query->update
        try:
           p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
           war=DBSession.query(warMap).filter_by(city_id=int(city_id)).one()
           #u=DBSession.query(operationalData).filter_by(userid=int(user_id)).one()
           ...
           return dict(id=1)
            ...
            return dict(id=0)
    @expose('json')
    def product(self,user_id,city_id,grid_id):# å¯¹å¤æ¥å£ï¼çäº§business produce warMap:query businessWrite:query->update operationalData:update
        try:
           p=DBSession.query(businessWrite).filter_by(city_id=int(city_id)).filter_by(grid_id=int(grid_id)).one()
           #u=DBSession.query(operationalData).filter_by(userid=int(user_id)).one()
           u=checkopdata(user_id)#cache
           ...
           if ti-p.producttime>=production[p.ground_id-300][3] or p.producttime==0:#time
            ...
            return dict(id=0)
    @expose('json')
    def expand(self,user_id,city_id,type):#å¯¹å¤æ¥å£ï¼æ©å°operationalData:query->update
        try:
            #u=DBSession.query(operationalData).filter_by(userid=int(user_id)).one()
            u=checkopdata(user_id)#cache
            type=int(type)
    ...
    def retlev(self,uid):
        ...
        try:
            ...
            return dict(friendlist=fs)
    @expose('json')
    def addppyfriend(self,uid,rrstring):#å¯¹å¤æ¥å£ï¼è¿åå¥½åç­çº§operationalData:query
        f=None
        s=''
        ukind=0
        try:
